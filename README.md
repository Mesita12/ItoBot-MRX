...
<p align="center"> 
<a href="https://github.com/mesita12"><img src="http://readme-typing-svg.herokuapp.com?font=mono&size=17&duration=4000&color=F7B11B&center=falso&vCenter=falso&lines=ItoBot-MRX++%F0%9F%90%88;Gracias+por+visitar+este+repositorio.+%F0%9F%92%96" height="90px"></a> 
</p>

<p align="center">
<img src="(https://www.google.com/url sa=i&url=https%3A%2F%2Fwww.pinterest.com%2Flugocornelio%2Fwali-y-eva%2F&psig=AOvVaw1z-cNliqNj-eBQSnWX9XJw&ust=1701635246788000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCOClzLXL8YIDFQAAAAAdAAAAABAE)" alt="ItoBot-MRX" width="900"/>
</p>

<p align="center">
<a href="#"><img title="ItoBot-MRX" src="https://img.shields.io/badge/SI TE AGRADA EL REPOSITORIO APOYAME CON UNA 🌟 ¡GRACIAS! -red?colorA=%255ff0000&colorB=%23017e40&style=for-the-badge"></a> 
<img src="https://i.pinimg.com/originals/d4/3c/90/d43c902873d4db8c85974dfd0798030b.gif" height="28px">
</p>  

<p align="center">
<a href="#"><img title="ItoBot-MRX" src="https://img.shields.io/badge/LEA TODO EL README-red?colorA=%F77F48FF&colorB=%F77F48FF&style=for-the-badge"></a> 
<a href="#"><img title="ItoBot-MRX" src="https://img.shields.io/badge/COMPATIBLE CON LA VERSIÓN MULTI DISPOSITIVOS DE WHATSAPP-red?colorA=%F77F48FF&colorB=%F77F48FF&style=for-the-badge">
...
<a href="https://www.tiktok.com/@mitnick.00?_t=8hqoauTF7dW&_r=1" target="_blank"> <img src="https://img.shields.io/badge/-TikTok-%23E4405F?style=for-the-badge&logo=tiktok&logoColor=black" target="_blank"></a> <img src="https://github.com/siegrin/siegrin/blob/main/Assets/Handshake.gif" height="30px">
</a>
</div>
...
<a href="http://wa.me/51976631425" target="blank"><img src="https://img.shields.io/badge/ItoBot-MRX-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" /> 

<a href="http://wa.me/51900330930?text=.estado" target="blank"><img src="https://img.shields.io/badge/Bot oficial-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" />
</a>
...
```
```bash
apt update -y && yes | apt upgrade && pkg install -y bash wget mpv && wget -O - https://raw.githubusercontent.com/Mesita12/ItoBot-MRX/master/install.sh | bash
```
-----
...
```
```bash
cd User/Usuario/.vscode/proyectos/ItoBot-MRX-master
```bash
yarn install
```
```bash
...
```
------------------
### 🚀 USAR ItoBot-MRX 24/7 EN TERMUX 
> Ejecutar estos comandos dentro de la carpeta ItoBot-MRX
```bash
...
``` 
----
### 😼 ACTUALIZAR ItoBot-MRX
> **Note** Comandos para actualizar ItoBot-MRX de forma automática
```bash
grep -q 'bash\|wget' <(dpkg -l) || apt install -y bash wget && wget -O - https://raw.githubusercontent.com/Mesita12/ItoBot-MRX/master/update.sh | bash 
```
...
------------------
- [x] Resultado <details><summary>Importar Repositorio - ItoBot-MRX</summary><img src="https://i.imgur.com/GQyRnMf.jpg"></details>
------------------
...
```bash
git clone https://github.com/Mesita12/ItoBot-MRX && cd ItoBot-MRX && npm install && npm update && node .
```
...
### `📝 NOTA 📝`
```bash
🔸ESTE REPOSITORIO SE PUBLICA LA VERSIÓN ACTUAL|OFICIAL DE ItoBot-MRX
...
🔸ItoBot-MRX, NO SE HACE RESPONSABLE DEL USO, NÚMERO, PRIVACIDAD Y CONTENIDO MANDADO, O USADO O GESTIONADO POR USTEDES O EL BOT.
```
----

### 🌟 EDITOR Y PROPIETARIO DEL BOT
<a href="https://github.com/Mesita12"><img src="https://github.com/Mesita12.png" width="300" height="300" alt="elrebelde21"/></a>
